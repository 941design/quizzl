...
> **Status:** Implemented 2026-07-19. All 41 acceptance criteria met; see
> `epic-state.json` for per-story evidence.
>
...
- **ADR-010** — Make Remove Member a universal admin-only eviction affordance
  with no co-admin broadcast. Codifies this epic's §1.1 "remove member —
  universal" decision as the project-wide model for group eviction.
