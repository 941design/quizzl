  ...
  treatments: {
    ...
    dynamic: {
      banner: {
        ...
        // Finalized lite-preset knobs (S9, AC-PERF-3) — see header comment
        // for the full derivation/measurement rationale.
        render: {
          zones: 2,
          layers: 3,
          darkening: 1,
