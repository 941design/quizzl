# Feature Specification Request: Direct-Contact Profile Exchange (self-healing, pull-based)

> **Status:** request / pre-spec. Complements `epic-contact-pairing-code`
> (mutual admission) and `epic-contact-card-exchange` (name-in-card). Hand to
> `/base:feature` to produce the implementation spec + acceptance criteria.
>
