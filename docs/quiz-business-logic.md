# Few — Quiz Engine Business Logic

This document describes the complete business logic of the Few quiz system: how questions are defined, how users interact with them, how answers are evaluated and scored, how progress is persisted, and how quiz data flows through the application.
...
Few supports **three question types**, defined as a discriminated union on the `type` field.
